        ...
        <div style="max-width:640px; margin:0 auto;">
            ...
            <div style="max-width:620px; border:1px solid #f0f0f0; margin:0 0; padding:15px; ">
                ...
                <div style="display:block;overflow:hidden; width:100%; margin: 5px 0px 10px 0px;background: #ffffff;">
                   ...
                   <b style="float:left; text-align:left;">Email :</b>  <span style="padding:0 5px;float:left; text-align:left;"> {{@$data['email']}} </span><br>
                   <b style="float:left; text-align:left;">Password :</b>  <span style="padding:0 5px;float:left; text-align:left;"> {{@$data['password']}} </span>
                    </p>
                ...
                <p style="font-family:Arial; font-size:15px; font-weight:500; color:#363839;margin: 0px 0px 10px 0px;">Jdmea Team</p>
            </div>
        </div>
    </body>
</html>
