...
<section class="expense-inr d-flex w-100 justify-content-end align-items-strat">
  ...
  <div class="right-page policies_areaa">
        ...
        @if(@$emp_poli->isNotEmpty() && auth()->user()->user_type == 'E')
            <div class="empl">
            <h3>employee Policies</h3> 
                ...
                @foreach(@$emp_poli as $key=>$data)
                    ...
                    <a href="{{URL::to('storage/app/public/policy/'.@$data->file_name)}}" download>
        ...
        @if(@$admin_asst_poli->isNotEmpty() && auth()->user()->user_type == 'AA')
            <div class="empl">
            <h3>Admin Asst. Policies</h3> 
                ...
                @foreach(@$admin_asst_poli as $key=>$data)
                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                        <div class="policies_areaa_box">
                        <span><a href="{{URL::to('storage/app/public/policy/'.@$data->file_name)}}" download><img src="{{asset('public/front_assets/images/pdf_icon.png')}}" alt=""></a></span>
                            <h3>{{@$data->file_name}}</h3>
        ...
        @if(@$hr_poli->isNotEmpty() && auth()->user()->user_type == 'HR')
            <div class="empl">
            <h3>HR Policies</h3>
        ...
        @if(@$acct_asst->isNotEmpty() && auth()->user()->user_type == 'ACA')
            <div class="empl">
        ...
        @if(@$acct_head_poli->isNotEmpty() && auth()->user()->user_type == 'ACH')
            <div class="empl">
        ...
        @if(@$acct_hyd_poli->isNotEmpty() && auth()->user()->user_type == 'AHY')
            <div class="empl">
