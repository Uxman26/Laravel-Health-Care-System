...
<section class="expense-inr d-flex w-100 justify-content-end align-items-strat">
    ...
    <div class="right-page policies_areaa">
        ...
        @include('includes.message')
            ...
            <a href="{{route('content.user.guide.list')}}">Back</a>
        </div>
        
        <!---->
        <div class="empl write_to_us">
           <h1>Upload Guide Files</h1>
           <form action="{{route('content.user.guide.submit')}}" method="post" id="policy_form" enctype="multipart/form-data">
           @csrf
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-8 col-md-8 col-sm-6 col-12">
                    <div class="fill-box">
                        ...
                        <div class="fill-box-file">
                            <input type="file" name="file_name[]" id="file_name" data-multiple-caption=""  accept="application/pdf" multiple>
                    ...
                    <div class="fill-box">
                        <label for="">Guide for User</label>
                           <select class="form-select" name="for_user" id="for_user">
                               <option value="">Select User</option>
                               <option value="E">Employee</option>
                               <!-- <option value="AA">Admin Asst</option> -->
    ...
    // })
        $("#policy_form").validate({
            ...
            submitHandler:function(form){
                if ($("#file_name").val() == '') {
                            $('#file_count').html('Please upload atleast 1 file');
